...
{$Z4}
  ...
  PAiFlowObjectType = ^TAiFlowObjectType;
  TAiFlowDecomposition = (
    DECOMP_OR       = 0,
    DECOMP_AND      = 1,
    DECOMP_CLUSTER  = 2 
  );
  PAiFlowDecomposition = ^TAiFlowDecomposition;
  TAiFlowDragHandlePosition = (
    DRAG_NONE           = 0,
    DRAG_TOP_LEFT       = 1,
    DRAG_TOP_RIGHT      = 2,
    DRAG_BOTTOM_LEFT    = 3,
  ...
  PAiFlowDragHandlePosition = ^TAiFlowDragHandlePosition;
  TAiFlowAlignMode = (
    ALIGN_LEFT       = 0,
    ALIGN_RIGHT      = 1,
    ALIGN_TOP        = 2,
  ...
  PAiFlowAlignMode = ^TAiFlowAlignMode;
...
function set_can_signal_raw_value(const ACANSignal: PMPCANSignal; const AData: pbyte; const AValue: uint64): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function set_lin_signal_raw_value(const ALINSignal: PMPLINSignal; const AData: pbyte; const AValue: uint64): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function set_flexray_signal_raw_value(const AFlexRaySignal: PMPFlexRaySignal; const AData: pbyte; const AValue: uint64): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function ini_read_string_wo_quotes(const AHandle: nativeint; const ASection: pansichar; const AKey: pansichar; AValue: pansichar; AValueCapacity: pInt32; const ADefault: pansichar): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function set_can_signal_value_verbose(const AChn: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMessageName: pansichar; const APDUName: pansichar; const ASignalName: pansichar; const ACANFD: PLIBCANFD; AValue: double): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function get_can_signal_value_verbose(const AChn: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMessageName: pansichar; const APDUName: pansichar; const ASignalName: pansichar; const ACANFD: PLIBCANFD; AValue: pdouble): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function get_flexray_signal_value_verbose(const AChn: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMessageName: pansichar; const APDUName: pansichar; const ASignalName: pansichar; const AFlexray: PLIBFlexRay; AValue: pdouble): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function set_flexray_signal_value_verbose(const AChn: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMessageName: pansichar; const APDUName: pansichar; const ASignalName: pansichar; const AFlexray: PLIBFlexRay; AValue: double): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function set_lin_signal_value_verbose(const AChn: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMessageName: pansichar; const ASignalName: pansichar; const ALIN: PLIBLIN; AValue: double): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}

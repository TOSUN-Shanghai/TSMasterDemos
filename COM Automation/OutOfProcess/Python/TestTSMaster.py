...
# read frame
read_result, cnt = com.fifo_read_can_buffer_frame_count(-1)
if read_result:
  print('count is', cnt)
  read_result, idxChn, isRemote, isExtended, dlc, id, timeUs, datas = com.fifo_receive_can_msg(-1, True)
  if read_result:
    print('A frame received, Channel index =', idxChn, ', time =', timeUs / 1000000.0, ', id =', id, ', data =', datas)
  else:
    print('Receive failed')
else:
  print('No frame is received')
  
r, s = app.get_system_var_generic('StatisticsCAN1.StdData');
if r:
   print('StatisticsCAN1.StdData = ' + s)  

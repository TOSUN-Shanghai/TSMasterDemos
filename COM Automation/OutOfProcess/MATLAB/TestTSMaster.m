...
formMan.load_project('.\Data\Demo\Automation\Configurations\EmptyConf.T7z', true);
...
app.log('0x345 is scheduled by 10 fps', LVL_OK);
app.wait(1000);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x346 is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x347 is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x348 is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x349 is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x34A is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x34B is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x34C is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x34D is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x34E is scheduled by 10 fps', LVL_OK);
app.wait(100);
% inc id
cFD.FIdentifier = cFD.FIdentifier + 1;
com.add_cyclic_msg_canfd_verbose(cFD.FIdxChn, cFD.FIsExtendedId, cFD.FIdentifier, ...
    cFD.FDLC, cFD.FDatas, 100);
app.log('0x34F is scheduled by 10 fps', LVL_OK);
app.wait(100);
app.wait(3000);
